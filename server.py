...
ignore_words = ['今日','日本','本日','💕\u3000','👋😆✨☀️','昨日','・・・','日本人','チョロ','u3000','～´∇｀ﾉ','日本国民','事無','毎日','一松','時間','中国','～♪','大事','今年','阪神','年月日', '本当','元気','可愛','松兄','仕事',
 ...
 '一日','・・・・・','本日分','ˊᵕˋ','全文','カラ','大人','日本食','⁾⁾','👋😆✨☀️\u3000','॑꒳','\u3000・思','トド','犯人',
 ...
 '朝起','裏切','入店','堀内康男氏','一番好','一足早','情報解禁','否定',"頑張","スマホ", "男子", ""]
...
def post_json():
    ...
    for cmp_noun, value in data_collection.most_common():
        if value > 10000000:
            if termextract.core.modify_agglutinative_lang(cmp_noun) in ignore_words:
                continue
            else:
                important_words.append(termextract.core.modify_agglutinative_lang(cmp_noun))
